...
const baseStyles = `
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .product-card { background: white; border-radius: 10px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); transition: 0.3s; position: relative; display: flex; flex-direction: column; justify-content: space-between; }
...
function renderProductCard(product) {
  return `
    <div class="product-card">
        ...
        <a href="/product/${product.id}" class="buy-btn">
