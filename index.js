...
function startBot() {
    ...
    try {
        ...
        // For Render, we need to handle the bot process differently
    ...
    res.send(`
        ...
        <body>
            <div class="login-container">
                ...
                <div style="color: #8892b0; margin-bottom: 30px;">Render Deployment</div>
...
app.get('/dashboard', requireAuth, (req, res) => {
    res.send(`
        ...
        <body>
            ...
            <div class="container">
                <div class="header">
                    <h1 class="title">GOAT-BOT V2</h1>
                    <p>Render Deployment | Owner: ${BOT_OWNER}</p>
                </div>

                <div class="status-panel">
                    <div class="status-header">
                        <div class="status-indicator offline" id="statusIndicator"></div>
                        <h2 id="statusTitle">SYSTEM OFFLINE</h2>
                    </div>
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    log.info(`🤖 Bot Control: Manual start via dashboard`);
});
