...
... (Author comments remain the same)
 */
...
const session = require('express-session'); // <-- Added for Admin Protection

const app = express();
const PORT = process.env.PORT || 3000;

let messengerApi = null; 
...
const STORE_CONFIG = {
  ...
  adminPassword: "admin", // <-- Change your password here
  sessionSecret: "your-super-secret-key-for-sessions-12345", // <-- Change this to something random
  features: {
    wishlist: true,
    orderTracking: true,
...
// (Product Generation Function... remains the same)
...
// --- Session Middleware ---
app.use(session({
  secret: STORE_CONFIG.sessionSecret,
  resave: false,
...
// --- REUSABLE HTML & CSS ---
// (baseStyles, headerHtml, footerHtml, searchScript, renderProductCard... all remain the same)
const baseStyles = `
        :root {
            --primary: #2c5aa0;
            --secondary: #ff6b35;
...
app.get('/product/:id', (req, res) => {
  // (Product detail route... remains the same)
...
app.get('/order/:productId', (req, res) => {
  // (Order page route... remains the same)
...
app.post('/submit-order', (req, res) => {
  // (Order submission logic... remains the same)
...
app.get('/products', (req, res) => {
  // (All products route... remains the same)
  res.send(`
<!DOCTYPE html>
<html lang="en">
<head>
...
app.get('/category/:category', (req, res) => {
  // (Category route... remains the same)
    ...
    <div class="login-wrapper">
        <div class="login-card">
            ...
            <form method="POST" action="/admin/login">
                ...
                <button type="submit" class="submit-btn" style="background: var(--primary);">
                    <i class="fas fa-sign-in-alt"></i> Login
                </button>
            </form>
            <a href="/" style="display: block; margin-top: 20px; color: var(--gray);">← Go back to Shop</a>
        </div>
    </div>
</body>
</html>
...
app.get('/admin', requireAdmin, (req, res) => { // <-- 'requireAdmin' middleware added
    ...
    <div class="page-wrapper" style="background: var(--light);">
        <div class="container">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                ...
                <a href="/admin/logout" class="logout-btn" style="margin-bottom: 0;">
...
app.get('/contact', (req, res) => {
  // (Contact route... remains the same)
  res.send(`
<!DOCTYPE html>
<html>
<head>
