...
// COMPLETE RANDOM WRONG COMMAND SUGGESTIONS (200+)
function getWrongCommandSuggestion(prefix, bestMatch) {
	const wrongCommandSuggestions = [
		...
		`✨ Galaxy guess~ ${prefix}${bestMatch}?`,
		`🦄 Sparkle horn~ ${prefix}${bestMatch}?`,
		`🍦 Sundae fun~ ${prefix}${bestMatch}?`,
		`🎯 Target hit~ ${prefix}${bestMatch}?`,
		`🌈 Rainbow end~ ${prefix}${bestMatch}?`,
		`🦩 Flamingo pose~ ${prefix}${bestMatch}?`,
		`🍉 Summer vibes~ ${prefix}${bestMatch}?`,
		`🎪 Circus magic~ ${prefix}${bestMatch}?`,
		`🦚 Royal fan~ ${prefix}${bestMatch}?`,
		`🍯 Bee happy~ ${prefix}${bestMatch}?`,
		`🌸 Spring bloom~ ${prefix}${bestMatch}?`,
		`🦉 Wisdom call~ ${prefix}${bestMatch}?`,
		`🍩 Sweet treat~ ${prefix}${bestMatch}?`,
		`🎸 Guitar riff~ ${prefix}${bestMatch}?`,
		`🦋 Metamorphosis~ ${prefix}${bestMatch}?`,
		`🌙 Moon magic~ ${prefix}${bestMatch}?`,
		`🧁 Baking time~ ${prefix}${bestMatch}?`,
		`🦈 Ocean king~ ${prefix}${bestMatch}?`,
		`🎨 Masterpiece~ ${prefix}${bestMatch}?`,
		`🍁 Fall colors~ ${prefix}${bestMatch}?`,
		`🦄 Dreamy night~ ${prefix}${bestMatch}?`,
		`🎪 Center stage~ ${prefix}${bestMatch}?`,
		`🍫 Cocoa dream~ ${prefix}${bestMatch}?`,
		`🌸 Pink cloud~ ${prefix}${bestMatch}?`,
		`🦚 Peacock dance~ ${prefix}${bestMatch}?`,
		`🎵 Harmony found~ ${prefix}${bestMatch}?`,
		`🍦 Cold delight~ ${prefix}${bestMatch}?`,
		`🌈 Color burst~ ${prefix}${bestMatch}?`,
		`🦉 Night wisdom~ ${prefix}${bestMatch}?`,
		`🎪 Big top fun~ ${prefix}${bestMatch}?`,
		`🍯 Golden sweet~ ${prefix}${bestMatch}?`,
		`🌸 Blossom rain~ ${prefix}${bestMatch}?`,
		`🦄 Fantasy land~ ${prefix}${bestMatch}?`,
		`🎸 Rock star~ ${prefix}${bestMatch}?`,
		`🍩 Hole story~ ${prefix}${bestMatch}?`,
		`🌈 Sky colors~ ${prefix}${bestMatch}?`,
		`🦚 Majesty call~ ${prefix}${bestMatch}?`,
		`🎪 Performance~ ${prefix}${bestMatch}?`,
		`🍫 Sweet bliss~ ${prefix}${bestMatch}?`,
		`🌸 Flower power~ ${prefix}${bestMatch}?`,
		`🦉 Knowledge seek~ ${prefix}${bestMatch}?`,
		`🎵 Rhythm flow~ ${prefix}${bestMatch}?`,
		`🍦 Creamy joy~ ${prefix}${bestMatch}?`,
		`🌈 Spectrum show~ ${prefix}${bestMatch}?`,
		`🦄 Magic touch~ ${prefix}${bestMatch}?`,
		`🎪 Show time~ ${prefix}${bestMatch}?`,
		`🍯 Nectar sweet~ ${prefix}${bestMatch}?`,
		`🌸 Garden walk~ ${prefix}${bestMatch}?`,
		`🦚 Regal beauty~ ${prefix}${bestMatch}?`,
		`🎸 Music soul~ ${prefix}${bestMatch}?`,
		`🍩 Circle fun~ ${prefix}${bestMatch}?`,
		`🌈 Light show~ ${prefix}${bestMatch}?`,
		`🦉 Ancient know~ ${prefix}${bestMatch}?`,
		`🎪 Stage light~ ${prefix}${bestMatch}?`,
		`🍫 Cocoa love~ ${prefix}${bestMatch}?`,
		`🌸 Nature's call~ ${prefix}${bestMatch}?`,
		`🦄 Mythic beast~ ${prefix}${bestMatch}?`,
		`🎵 Melodic tune~ ${prefix}${bestMatch}?`,
		`🍦 Frozen joy~ ${prefix}${bestMatch}?`,
		`🌈 Color dance~ ${prefix}${bestMatch}?`,
		`🦚 Pride walk~ ${prefix}${bestMatch}?`,
		`🎪 Circus life~ ${prefix}${bestMatch}?`,
		`🍯 Amber gold~ ${prefix}${bestMatch}?`,
		`🌸 Cherry bloom~ ${prefix}${bestMatch}?`,
		`🦉 Wise words~ ${prefix}${bestMatch}?`,
		`🎸 String play~ ${prefix}${bestMatch}?`,
		`🍩 Ring joy~ ${prefix}${bestMatch}?`,
		`🌈 Prism light~ ${prefix}${bestMatch}?`,
		`🦄 Legendary~ ${prefix}${bestMatch}?`,
		`🎪 Big top joy~ ${prefix}${bestMatch}?`,
		`🍫 Brown sweet~ ${prefix}${bestMatch}?`,
		`🌸 Floral scent~ ${prefix}${bestMatch}?`,
		`🦚 Display time~ ${prefix}${bestMatch}?`,
		`🎵 Note perfect~ ${prefix}${bestMatch}?`,
		`🍦 Chill time~ ${prefix}${bestMatch}?`,
		`🌈 Sky bridge~ ${prefix}${bestMatch}?`,
		`🦉 Moon guide~ ${prefix}${bestMatch}?`,
		`🎪 Fun house~ ${prefix}${bestMatch}?`,
		`🍯 Sweet flow~ ${prefix}${bestMatch}?`,
		`🌸 Spring time~ ${prefix}${bestMatch}?`,
		`🦄 Horn light~ ${prefix}${bestMatch}?`,
		`🎸 Chord play~ ${prefix}${bestMatch}?`,
		`🍩 Round treat~ ${prefix}${bestMatch}?`,
		`🌈 Light bridge~ ${prefix}${bestMatch}?`,
		`🦚 Feather show~ ${prefix}${bestMatch}?`,
		`🎪 Tent fun~ ${prefix}${bestMatch}?`,
		`🍫 Dark sweet~ ${prefix}${bestMatch}?`,
		`🌸 Bloom time~ ${prefix}${bestMatch}?`,
		`🦉 Forest know~ ${prefix}${bestMatch}?`,
		`🎵 Sound joy~ ${prefix}${bestMatch}?`,
		`🍦 Cold treat~ ${prefix}${bestMatch}?`,
		`🌈 Color joy~ ${prefix}${bestMatch}?`,
		`🦄 Magic horn~ ${prefix}${bestMatch}?`,
		`🎪 Show biz~ ${prefix}${bestMatch}?`,
		`🍯 Liquid gold~ ${prefix}${bestMatch}?`,
		`🌸 Nature joy~ ${prefix}${bestMatch}?`,
		`🦚 Royal walk~ ${prefix}${bestMatch}?`,
		`🎸 Music time~ ${prefix}${bestMatch}?`,
		`🍩 Sweet circle~ ${prefix}${bestMatch}?`,
		`🌈 Light joy~ ${prefix}${bestMatch}?`,
		`🦉 Wisdom time~ ${prefix}${bestMatch}?`,
		`🎪 Big fun~ ${prefix}${bestMatch}?`,
		`🍫 Sweet time~ ${prefix}${bestMatch}?`,
		`🌸 Flower joy~ ${prefix}${bestMatch}?`,
		`🦄 Dream time~ ${prefix}${bestMatch}?`,
		`🎵 Music joy~ ${prefix}${bestMatch}?`,
		`🍦 Cold joy~ ${prefix}${bestMatch}?`,
		`🌈 Color fun~ ${prefix}${bestMatch}?`,
		`🦚 Beauty time~ ${prefix}${bestMatch}?`,
		`🎪 Fun time~ ${prefix}${bestMatch}?`,
		`🍯 Sweet gold~ ${prefix}${bestMatch}?`,
		`🌸 Bloom joy~ ${prefix}${bestMatch}?`,
		`🦉 Know time~ ${prefix}${bestMatch}?`,
		`🎸 Play time~ ${prefix}${bestMatch}?`,
		`🍩 Joy circle~ ${prefix}${bestMatch}?`,
		`🌈 Light fun~ ${prefix}${bestMatch}?`,
		`🦄 Magic time~ ${prefix}${bestMatch}?`,
		`🎪 Joy time~ ${prefix}${bestMatch}?`,
		`🍫 Joy sweet~ ${prefix}${bestMatch}?`,
		`🌸 Joy bloom~ ${prefix}${bestMatch}?`,
		`🦚 Joy beauty~ ${prefix}${bestMatch}?`,
		`🎵 Joy sound~ ${prefix}${bestMatch}?`,
		`🍦 Joy cold~ ${prefix}${bestMatch}?`,
		`🌈 Joy color~ ${prefix}${bestMatch}?`
	];
	return wrongCommandSuggestions[Math.floor(Math.random() * wrongCommandSuggestions.length)];
}

// Smart prefix only responses
const prefixOnlyResponses = [
	`✨ That's just my prefix darling~ Try ${prefix}help to see all available commands!`,
	`🎀 Just the prefix won't do cutie! Try ${prefix}help for commands~`,
	`💫 Oopsie~ That's only my prefix! Try ${prefix}gpt or ${prefix}help babe!`,
	`🌸 Prefix detected! Need help sweetie? Try ${prefix}help for commands~`,
	`🦋 That's my prefix honey~ Try adding a command like ${prefix}help!`,
	`💞 Just the prefix? Try ${prefix}hgen or ${prefix}help for fun commands cutie!`,
	`🎵 Melodic prefix~ but try ${prefix}help for the real symphony!`,
	`🍯 Sweet prefix! Now try ${prefix}help for the honey commands~`,
	`🌟 Sparkly prefix! Add a command like ${prefix}gpt for magic!`,
	`💌 Love the prefix! Now try ${prefix}help for love commands~`
];
	...
	return async function (event, message) {
		...
		*/
		...
		async function onStart() {
			...
			// ✅ SMART FEATURE: Prefix Only Text Response
			if (body.trim() === prefix.trim()) {
				const randomResponse = prefixOnlyResponses[Math.floor(Math.random() * prefixOnlyResponses.length)].replace(/{prefix}/g, prefix);
			...
			if (!command) {
				// ✅ SMART FEATURE: Wrong Command Suggestion with 200+ Random Messages
				if (commandName && !hideNotiMessage.commandNotFound) {
					...
					// If no good match found, use cute error message
		...
		*/
		async function onReaction() {
			// ✅ SMART FEATURE: Admin Reaction Unsend
			// Check if admin reacts with any unsend emoji to unsend message
			if (adminUnsendEmojis.includes(event.reaction)) {
				// Check if user is admin (role 1 = box admin, role 2 = bot admin)
				if (role >= 1) {
					try {
						await api.unsendMessage(event.messageID);
						log.info("ADMIN UNSEND", `Message ${event.messageID} unsent by admin ${senderID} with reaction ${event.reaction}`);
